...
date: 2015-04-29T10:00:19+00:00
...
The Pew Research Center just released a <a href="http://www.pewinternet.org/2015/04/21/open-government-data/" target="_blank">report on how Americans view open government data</a>. The following findings were based on a November to December 2014 survey of 3,212 adults.
  ...
  5. **Roughly half of Americans think that open data will improve government.**
    ...
    That is good news, but that also means that half of the respondents think that [open data](https://www.digitalgov.gov/tag/open-data/) will not improve government. Specifically, 49% think that open data will improve government services while an equal percentage think that open data will have no effect on the delivery of government services.
