...
date: 2013-10-30T08:45:15+00:00
...
Improving the federal government’s ability to deliver digital information anytime, anywhere, on any device—via open content—is a key goal of the [Digital Government Strategy](https://obamawhitehouse.archives.gov/sites/default/files/omb/egov/digital-government/digital-government.html). A [content management system](http://en.wikipedia.org/wiki/Content_management_system) (CMS) can help your agency move to an [open content model](https://www.digitalgov.gov/2014/05/05/government-open-and-structured-content-models-are-here/ "Government Open and Structured Content Models Are Here!"), making it easier for people to find, share, use, and re-use your information.

The key steps in getting ready to move to a CMS include:

  * [Prepare Your Content](https://www.digitalgov.gov/resources/content-management-systems-toolkit/#prepare "Content Management Systems Toolkit")
  * [Choose a CMS](https://www.digitalgov.gov/resources/content-management-systems-toolkit/#choose "Content Management Systems Toolkit")
  * [Migrate Your Content to a CMS](https://www.digitalgov.gov/resources/content-management-systems-toolkit/#migrate "Content Management Systems Toolkit")

## Prepare Your Content {#prepare}

### Develop a Content Strategy

A [content strategy](https://www.digitalgov.gov/?s=content+strategy) defines such things as topics, themes and purpose, and can also play a part in website governance, customer experience, metadata and search engine optimization (SEO). The value of developing a content strategy is that it forces you to examine what you’re trying to accomplish with your digital content, where you need it delivered, and desired outcomes.
...
Before implementing a CMS, you should get rid of “ROT” (Redundant, Outdated, Trivial) content. Your completed content inventory can help you spot the ROT.
  ...
  * [Examine your metrics](https://www.digitalgov.gov/category/metrics/). Do you have pages that are only getting a few visits a month? Those pages may not be worth keeping, if no one is looking at them.
...
See how [EPA uses Dublin Core metadata to structure content](https://www.digitalgov.gov/files/2014/07/metadata-in-drupal-epa.pdf) (PDF, 109 KB, 16 pages, November 2012).
...
[Metadata](http://en.wikipedia.org/wiki/Metadata) is essentially “data about data,” and consists of machine-readable descriptions that tell other computers important facts about your digital content. It provides a standardized system to label and classify content. It also:
  ...
  * Enables content aggregation, re-use, and syndication via Really Simple Syndication (RSS), [Application Programming Interfaces (APIs)](https://www.digitalgov.gov/category/code/api/), and other technologies
...
Use these tools to document how well different products match your requirements. This will help you to identify the one that will work best for you.
  ...
  * [CMS Solution Evaluation Tool](https://www.digitalgov.gov/files/2014/07/sample-cms-solution-evaluation-tool.xlsx)  (MS Excel, 36 KB, 1 sheet, November 2012)—a sample spreadsheet used to compare, rate, and rank different CMS tools side-by-side, based on features and functionality
...
Use this [sample Web CMS Requirements doc](https://www.digitalgov.gov/files/2014/07/cms-requirements-for-sow.docx) (MS Word, 90 KB, 27 pages, December 2012) as a model to document everything that your CMS should do.
...
Use this [Use this sample CMS User Roles and Needs](https://www.digitalgov.gov/files/2014/07/cms-user-roles-and-needs.docx) (MS Word, 13 KB, 1 page, December 2012) to document different types of CMS users and the common tasks each will need to perform.
...
Here are some examples of both a very basic project outline, and a detailed project plan:
  ...
  * [Sample Task List for Website Redesign](https://www.digitalgov.gov/files/2014/07/task-list-for-website-redesign.docx) (MS Word, 13 KB, 2 pages, December 2012) shows a high-level project outline
  * [Sample Website Redesign Schedule](https://www.digitalgov.gov/files/2014/07/website-redesign-final-schedule.pdf) (PDF, 249 KB, 10 pages, December 2012) shows a detailed website migration project plan
...
A Statement of Work/Objectives (SOW/SOO) will help you retain the services of a 3rd-party contractor to assist with installing and configuring your new CMS, and migrating your content. Work with your Contracting Office to execute an SOO/SOW.
  ...
  * [Sample Statement of Objectives—Website CMS migration, development and support](https://www.digitalgov.gov/files/2014/07/sample-statement-of-objectives-website-migration.docx) (MS Word, 53 KB, 14 pages, November 2012)—GSA
  * [Sample Statement of Objectives—Website CMS consolidation](https://www.digitalgov.gov/files/2014/07/sample-statement-of-objectives-website-consolidation.docx) (MS Word, 53 KB, 12 pages, November 2012)—GSA
...
Document who’s responsible for every piece of the migration project, so nothing falls through the cracks.
  ...
  * A [Project Charter](https://www.digitalgov.gov/files/2014/07/sample-website-project-charter.docx) can ensure you have project buy-in from stakeholders across your organization.
...
A successful migration depends on support from management and buy-in from stakeholders.
  ...
  * See a [sample marketing flyer from EPA](https://www.digitalgov.gov/files/2014/07/one-epa-web.pdf) (PDF, 543 KB, 2 pages, November 2012) about their migration to Drupal. It outlines what they’re doing, why they’re doing it, and how it will work.
...
If you’re making any design changes along with your content migration, do [user testing](https://www.digitalgov.gov/category/ux/user-testing-research/) early-on, to gather feedback and make improvements before launch.
...
[Content Migration Validation Checklist](https://www.digitalgov.gov/files/2014/07/content-migration-validation-checklist.xlsx) (MS Excel, 41 KB, 1 sheet, December 2012)
...
If you’ve done your research and followed your plan, you should have a smooth migration. Once it’s all done, and the site is live in the new CMS:
  ...
  * Consider writing a case study, and [send to us](https://www.digitalgov.gov/contact-us/ "Contact Us") so we can post on DigitalGov, so others can benefit from your experiences.
...
### Case Studies
  ...
  * [Why NCI Moved to a Structured Content Model](https://www.digitalgov.gov/2013/07/25/why-nci-moved-to-a-structured-content-model/ "Why NCI Moved to a Structured Content Model")
  * [How NASA Chose a New Content Management System](https://www.digitalgov.gov/2012/11/21/how-nasa-chose-a-new-content-management-system/ "How NASA Chose a New Content Management System")
  * [How the Department of Education Automated Publication of Press Releases](https://www.digitalgov.gov/2012/11/21/how-the-department-of-education-automated-publication-of-press-releases/ "How the Department of Education Automated Publication of Press Releases")