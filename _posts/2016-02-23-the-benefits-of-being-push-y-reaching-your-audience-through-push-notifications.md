...
date: 2016-02-23T13:00:27+00:00
...
[Push notifications](https://www.digitalgov.gov/2015/06/30/trends-on-tuesday-native-app-push-notifications-drive-repeat-use/) allow agencies to connect with their audiences for immediate communication. The Office of Personnel Management’s [OPM Alert app](https://www.opm.gov/policy-data-oversight/snow-dismissal-procedures/mobile-app/) provides a real time look at the current operating status for federal offices in the Washington, DC, area and uses push technology to alert users of status changes.

<div id="attachment_343293" style="width: 610px" class="wp-caption aligncenter">
  <img class="size-full wp-image-343293" src="https://s3.amazonaws.com/sitesusa/wp-content/uploads/sites/212/2016/02/600-x-400-Push-notifications-elements-set-dark-Background-Olyzel-iStock-Thinkstock-488569892.jpg" alt="Push notifications elements set" width="600" height="400" />
  
  <p class="wp-caption-text">
    Olyzel/iStock/Thinkstock
  </p>
</div>
