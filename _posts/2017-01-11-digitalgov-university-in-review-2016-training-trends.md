...
date: 2017-01-11T12:00:02+00:00
...
<img class="aligncenter size-full wp-image-386474" src="https://www.digitalgov.gov/files/2017/04/600-x-127-DigitalGov_University.png" alt="DigitalGov University (D G U) logo" width="600" height="127" />
...
Some of our most popular training topics throughout the year focused on using programs such as analytics trainings offered through the [Digital Analytics Program](https://www.digitalgov.gov/services/dap/) and trainings on how to use the [DigitalGov Search](https://www.digitalgov.gov/services/search/) program. Other popular events were from the various [DigitalGov Communities](https://www.digitalgov.gov/communities/) like the [MobileGov Community of Practice](https://www.digitalgov.gov/communities/mobile/), [Challenge and Prizes Community of Practice](https://www.digitalgov.gov/communities/challenges-prizes-community/), and the [Government Customer Experience Community of Practice](https://www.digitalgov.gov/communities/customer-experience-community/) where best practices, case studies, and innovations were shared.
...
One of the highest attended (and highest rated) events came from longtime community member, [Sam Bronson](https://www.digitalgov.gov/author/sam-bronson/) of HHS, who shared the need for actionable analytics and the important steps agencies can take in setting up their own analytics program in his webinar, “[The Golden Partnership: How to Improve Website Findability with Actionable Analytics and Content Analysis](https://www.youtube.com/watch?v=Pjc-dEPBExE).” In fact, we heard from one attendee following the event who [has written about how it inspired her to take a different approach for a website project](https://medium.com/@DigitalGov/well-begun-is-half-done-lets-tidy-up-the-website-c19134c53af). We’d like to host more events driven by [community members in the digital government space](https://www.digitalgov.gov/communities/) so we look forward to more examples of great work being done in 2017. We’ll also continue to make sure that all of our trainings have an online component that let’s you attend from anywhere.

<div id="attachment_343147" style="width: 610px" class="wp-caption aligncenter">
  <img class="size-full wp-image-343147" src="https://www.digitalgov.gov/files/2016/01/600-x-450-E-learning-concept-Schooldesk-and-chalkboard-on-the-laptop-keyboard-Bet_Noire-iStock-Thinkstock-480287872.jpg" alt="E-learning concept: schooldesks and a chalkboard on a laptop keyboard" width="600" height="450" />
...
](https://www.youtube.com/watch?v=Qcs-Ce0Hzys) This webinar provided an overview of the upcoming [Open Opportunities](https://openopps.digitalgov.gov/) pilot for the Acquisition Community
...
](https://www.digitalgov.gov/event/cloud-native-devops-with-cloud-gov/) This workshop provided an introduction to the cloud.gov service by showing how to leverage the power of the cloud, and how to reduce duplication and start focusing on the creative work your team needs to deliver on their mission.
  4. [Automatic for the People: AI, Machine Learning and Chatbots for Digital Customer Service in Government
  
](https://www.digitalgov.gov/event/automatic-for-the-people-ai-machine-learning-and-chatbots-for-digital-customer-service-in-government/) This session covered how automated services powered by government data and new advances in artificial intelligence and machine learning can help improve and expand digital customer service initiatives.
  5. [October Challenge and Prize Community of Practice meeting
  
](https://www.digitalgov.gov/event/october-challenge-prize-community-of-practice-meeting/) This quarterly informative session highlighted the latest in public-sector prize practice.
