...
date: 2013-04-30T14:12:53+00:00
...
<div id="attachment_192202" style="width: 260px" class="wp-caption alignright">
  <img class="size-full wp-image-192202" src="https://s3.amazonaws.com/sitesusa/wp-content/uploads/sites/212/2014/08/250-x-86-API-letter-blocks-23575697-Hemera-Technologies-PhotoObjects.net-Thinkstock-87667306.jpg" alt="Children's building blocks letters spelling A P I." width="250" height="86" />
...
Learn more about the [benefits of APIs](https://www.digitalgov.gov/2013/03/12/benefits-of-apis/ "Benefits of APIs").
...
Learn more about [API technical choices](https://www.digitalgov.gov/2013/03/12/api-basics#common-technical-choices "API Basics").
...
APIs need to provide value to your agency and to developers. The best way to make that happen is to tie an API program to your agency mission.
  ...
  1. **Audit**: Investigate what API efforts may already be active at your agency. Assemble a list of the information that your team or agency produces and the services you provide. Decide what material you would like to offer via API. Read more**** on [auditing APIs](https://www.digitalgov.gov/2013/03/12/how-to-get-started-with-apis#audit "How to Get Started with APIs").**** 
  2. **Assemble Components**: Coordinate the creation of the API itself. Assemble the related documentation, components, and rollout plan. Test the API and coordinate with stakeholders. Read more**** on**** [assembling the components](https://www.digitalgov.gov/2013/03/12/how-to-get-started-with-apis#assemble-components "How to Get Started with APIs").
  3. **Implement**: Release the API to the intended audience, announce through marketing and community channels, and engage interested users. Read more**** on [implementing the API](https://www.digitalgov.gov/2013/03/12/how-to-get-started-with-apis#implement "How to Get Started with APIs").
  4. **Track Progress**: Monitor usage statistics, make improvements, and continue to engage with developers using the API. Read more [tracking the progress](https://www.digitalgov.gov/2013/03/12/how-to-get-started-with-apis/ "How to Get Started with APIs").
  5. **Repeat**: Re-evaluate lessons learned with your agency’s Web presence and consider what material next makes sense as an API. Repeat the above steps. Read more about [repeating the process](https://www.digitalgov.gov/2013/03/12/how-to-get-started-with-apis/ "How to Get Started with APIs").

## Resources and Tools for Building APIs

  * [Hosted API Tools](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#hosted-api-tools)
  * [API Standards Template](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#api-standards-template)
  * [Examples of APIs in Government](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#examples-apis-government)
  * [API Education Series](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#api-education-series)
  * [Case Studies](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#case-studies)
  * [How to Make APIs—An Overview](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#how-to-make-apis-overview)
  * [Producing APIs through Data.gov](https://www.digitalgov.gov/2013/04/30/producing-apis-through-data-gov/)
  * [API Release Kit](https://www.digitalgov.gov/2013/05/16/api-release-kit/)
  * [/Developer Kit](https://www.digitalgov.gov/2013/05/21/developer-kit/)
  * [U.S. Government APIs Listserv](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#government-api-listserv)
  * [Recommended Reading](https://www.digitalgov.gov/2013/03/12/resources-and-tools-for-apis#recommended-reading)
